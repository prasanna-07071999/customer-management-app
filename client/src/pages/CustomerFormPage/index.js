...
class CustomerFormPage extends Component {
    ...
    fetchCustomer = async () => {
        ...
        try {
            ...
            this.setState({ firstName, lastName, phoneNumber, isLoading: false, error: false })
        } catch (e) {
    ...
    render() {
        const { firstName, lastName, phoneNumber, isLoading, id, error } = this.state
        if (isLoading) return this.renderLoader()

        if (error) return <p>Failed to fetch Customer Details. Please try again later.</p>
