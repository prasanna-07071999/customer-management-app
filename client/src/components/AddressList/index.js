...
class AddressList extends Component {
  ...
  refreshAddresses = async () => {
    ...
    try {
      const response = await axios.get(`https://customer-management-backend-73do.onrender.com/api/customers/${customerId}/addresses`);
...
handleDeleteClick = async (addressId) => {
    try {
      await axios.delete(`https://customer-management-backend-73do.onrender.com/api/addresses/${addressId}`);
